...
def distorted_inputs(stats_dict, batch_size, anno_file_batch_rows):
  ...
  bbox = np.asarray([info['bbox'] for info in infos])
  ...
  # org_gt_coords2 = np.round(np.divide(org_gt_coords2, scaling_factor),4)
  ...
  meta_dict['org_gt_coords_ll0'] = org_gt_coords
  meta_dict['org_gt_coords_ll1'] = org_gt_coords2
...
def getImage(meta_rec, stats_dict):
    ...
    #TODO: Bugfix - check if this normalizaton is working  

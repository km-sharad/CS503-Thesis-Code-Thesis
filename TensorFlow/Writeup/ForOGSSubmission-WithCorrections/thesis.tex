...
\usepackage[colorlinks=true,linkcolor=blue,breaklinks=true,plainpages=true]{hyperref}
...
\begin{document}
  ...
  \end{titlepage}
    ...
    \begin{wrapfigure}{r}{0.50\textwidth}
        ...
        \end{center}
        \caption{Element-wise product and sum of the \textit{3 X 3} kernel with an input of dimension \textit{5 X 5} produces an output of \textit{3 X 3} dimension. Element-wise product and sum of the kernel with nine cells in the top left corner of the input produces the output in the top left cell of the output.}
    \end{wrapfigure}    

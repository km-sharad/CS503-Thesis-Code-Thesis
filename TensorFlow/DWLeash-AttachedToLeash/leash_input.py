...
data_dir = '../DWLeash-HandHoldingLeash/dog_walking_dataset/'
max_im_side = 500
init_padding = 32
min_side = 64
start_offset = 16
...
def getImage(meta_rec, stats_dict):
    im_meta_dict = {}
    im_meta_dict['gt_x_coord'] = int(float(meta_rec[2]))  #holding leash x
    im_meta_dict['gt_y_coord'] = int(float(meta_rec[3]))  #holding leash y

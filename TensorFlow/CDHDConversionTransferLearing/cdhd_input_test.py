...
# def distorted_inputs(batch_size, anno_file_batch_rows):
  ...
  for image_idx in xrange(batch_size):
    ...
    # [image, target_loc, info] = getImage(meta_rec)
...
def getImage(meta_rec, stats_dict):  
    ...
    target_loc[0] = int(round(im_meta_dict['gt_x_coord'],0))    
    target_loc[1] = int(round(im_meta_dict['gt_y_coord'],0))   
